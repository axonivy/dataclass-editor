...
var schemaUri =
  'https://jenkins.ivyteam.io/job/core_json-schema/job/master/lastSuccessfulBuild/artifact/workspace/ch.ivyteam.ivy.dataclass.editor.lsp.schema/target/schema/dataclass/13.2.0/dataclass-tsgen.json';
